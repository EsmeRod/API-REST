...
class Activity_Alumno_Item(private val alumnos: List<Alumno>) :
    RecyclerView.Adapter<Activity_Alumno_Item.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder
    {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_alumno_item, parent, false)
